						...
						<Grid item xs={12} sm={8} align="center">
							<ButtonGroup fullWidth aria-label="Full width outlined button group">
								<Button
									...
									Users
									<Chip size="small" label={github.usersTotal} className={classes.chip} />
								</Button>
								<Button
									onClick={() => selectType("Repositories")}
									className={active === "Repositories" ? "sActive" : "sInactive"}>
									Repositories
									<Chip size="small" label={github.reposTotal} className={classes.chip} />
								</Button>
							</ButtonGroup>
						</Grid>
					</Grid>
...
export default connect(mapStateToProps, null)(withRouter(TypeSelector));
